...
if __name__ == "__main__":
    ...
    reward=read_large_csv('/local/scratch/exported/Ethereum_token_txs_data_TY_23/rewards/eth2_reward_ether/daily_attestation_reward/total_daily_attestation_rewards_sum__address_level.csv')
    ...
    for i in tqdm(range(len(indexs))):  
        ...
        for j in tqdm(reward1.columns):
            ...
            IndexValues.to_csv(f'/local/scratch/exported/Ethereum_token_txs_data_TY_23/rewards/mining_staking/staking/decentralization_index/{index_name[i]}_{j}_pos_address_level.csv',index=False)
